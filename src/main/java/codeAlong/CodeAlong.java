...
public class CodeAlong {
    public static void main(String[] args) {
        //if u wanted this method to rethrow the exception, then u would have put it in the method
        // signature and not done the try/catch stuff in the block of code
        //throw throws away all responsibility
        //createNewFile();
